...
public:
   ...
   */
    ...
    virtual std::any visitTableListItem(IIC3413DBParser::TableListItemContext *context) = 0;

    virtual std::any visitLeftOuterJoin(IIC3413DBParser::LeftOuterJoinContext *context) = 0;

    virtual std::any visitOuterJoinOn(IIC3413DBParser::OuterJoinOnContext *context) = 0;

    virtual std::any visitOuterJoinComp(IIC3413DBParser::OuterJoinCompContext *context) = 0;
