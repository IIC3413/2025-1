...
public:
  ...
  virtual std::any visitTableListItem(IIC3413DBParser::TableListItemContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitLeftOuterJoin(IIC3413DBParser::LeftOuterJoinContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitOuterJoinOn(IIC3413DBParser::OuterJoinOnContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitOuterJoinComp(IIC3413DBParser::OuterJoinCompContext *ctx) override {
    return visitChildren(ctx);
  }
