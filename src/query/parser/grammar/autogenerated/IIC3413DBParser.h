...
public:
  ...
  enum {
    ...
    RuleColumnList = 8, RuleFromStatement = 9, RuleTableList = 10, RuleTableListItem = 11, 
    RuleLeftOuterJoin = 12, RuleOuterJoinOn = 13, RuleOuterJoinComp = 14, 
    RuleTable = 15, RuleWhereStatement = 16, RuleAndExpr = 17, RuleSimpleExpr = 18, 
    RuleComparisonExpr = 19, RuleLikeExpr = 20, RuleBetweenExpr = 21, RuleColumnOrConstant = 22, 
    RuleColumn = 23, RuleConstant = 24, RuleIdentifier = 25, RuleLimitStatement = 26, 
    RuleKeyword = 27
  };
